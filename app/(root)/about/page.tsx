...
// import { BookOpen, Tool, Globe } from 'lucide-react';
const page = () => {
  const BookIcon = () => (
  ...
  return <div className="flex flex-col xl:flex-row items-center justify-center w-full h-screen md:h-screen">
    ...
    <div className="flex flex-col items-center md:items-end mt-48 md:mt-0 pr-2 text-center xl:w-2/6">
      {/* Title */}
    ...
    <div className="hidden md:flex justify-center items-center pl-2 w-full lg:w-5/6 h-2/3 lg:h-5/6">
      {/* Bento Grid */}
