                            ...
                            {items.map((item, idx) => (
                                ...
                                >
                                    <Link
                                        href={item.href}
                                        key={item.title}
                                        className="h-12 w-12 rounded-full glassmorphism flex items-center justify-center"
                                    >
...
const FloatingDockDesktop = ({
    ...
    return (
        <motion.div
            ...
            className={cn(
                "mx-auto hidden md:flex h-16 gap-4 items-end rounded-2xl glassmorphism px-4 pb-3",
                className
            )}
        >
            {items.map((item) => (
